...
from compass.utils.ramp import gen_ramp
    ...
    for burst_id, bursts in _bursts_grouping_generator(cfg.bursts):
        ...
        with h5py.File(output_hdf5, 'w') as geo_burst_h5:
            ...
            for b in bursts:
                ...
                #ramping SLC 
                temp_slc_path_ramp = temp_slc_path.replace('_temp.vrt',
                                                                  '_ramp_temp.rdr')

                gen_ramp(b,temp_slc_path,temp_slc_path_ramp,az_carrier_poly2d)
                temp_slc_path = temp_slc_path_ramp    
